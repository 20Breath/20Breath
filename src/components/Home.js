...
import { Activity, Brain, Clapperboard, HeartPulse, Stethoscope } from "./Icons.js?v=20260628-visual-polish3";
import { goTo, h, pageTransition, revealItem, staggerContainer, viewportReveal } from "../utils.js?v=20260628-visual-polish3";
