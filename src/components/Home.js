    ...
    h(
      ...
      h(
        ...
        h(
          ...
          h("button", { onClick: () => goTo("socials"), className: "rounded-full bg-white px-8 py-3.5 text-base font-black text-navy shadow-soft transition hover:bg-medical hover:text-white" }, "تابع منصاتنا")
        )
      )
    ),
    h(
